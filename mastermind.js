...
checkActualCode = function(){
	...
	actualRowNr++;
	if (actualRowNr > 12) {
		if	(alert("Helaas uw kansen zijn op")){}
		else {
    		window.location.reload();
    	}
	}
...
document.getElementById("colorBrown").addEventListener("click", pickColorBrown);
